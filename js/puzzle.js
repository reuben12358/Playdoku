...
const CATEGORIES = {
  ...
  countries: [
    { id: 'brazil', label: 'Brazil', value: 'Brazil', type: 'country', emoji: '🇧🇷' },
    { id: 'argentina', label: 'Argentina', value: 'Argentina', type: 'country', emoji: '🇦🇷' },
    { id: 'france', label: 'France', value: 'France', type: 'country', emoji: '🇫🇷' },
    { id: 'germany', label: 'Germany', value: 'Germany', type: 'country', emoji: '🇩🇪' },
    { id: 'spain', label: 'Spain', value: 'Spain', type: 'country', emoji: '🇪🇸' },
    { id: 'england', label: 'England', value: 'England', type: 'country', emoji: '🏴󠁧󠁢󠁥󠁮󠁧󠁿' },
    { id: 'italy', label: 'Italy', value: 'Italy', type: 'country', emoji: '🇮🇹' },
    { id: 'portugal', label: 'Portugal', value: 'Portugal', type: 'country', emoji: '🇵🇹' },
    { id: 'netherlands', label: 'Netherlands', value: 'Netherlands', type: 'country', emoji: '🇳🇱' },
  ],
  leagues: [
    { id: 'premier_league', label: 'Premier League', value: 'Premier League', type: 'league', emoji: '🏴󠁧󠁢󠁥󠁮󠁧󠁿' },
